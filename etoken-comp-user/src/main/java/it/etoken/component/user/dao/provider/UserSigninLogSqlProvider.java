...
import it.etoken.base.model.user.entity.UserSigninLogExample.Criterion;
import it.etoken.base.model.user.entity.UserSigninLogExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class UserSigninLogSqlProvider {
     ...
     */
    public String countByExample(UserSigninLogExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("user_signin_log");
     ...
     * @mbg.generated Tue May 22 18:15:17 CST 2018
     */
    public String deleteByExample(UserSigninLogExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("user_signin_log");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Tue May 22 18:15:17 CST 2018
     */
    public String insertSelective(UserSigninLog record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("user_signin_log");
     ...
     * @mbg.generated Tue May 22 18:15:17 CST 2018
     */
    public String selectByExample(UserSigninLogExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        UserSigninLog record = (UserSigninLog) parameter.get("record");
        UserSigninLogExample example = (UserSigninLogExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("user_signin_log");
     ...
     * @mbg.generated Tue May 22 18:15:17 CST 2018
     */
    public String updateByPrimaryKeySelective(UserSigninLog record) {
        SQL sql = new SQL();
        sql.UPDATE("user_signin_log");
     ...
     * @mbg.generated Tue May 22 18:15:17 CST 2018
     */
    protected void applyWhere(SQL sql, UserSigninLogExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
